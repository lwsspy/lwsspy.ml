...
class ImbalancedDatasetSampler(torch.utils.data.sampler.Sampler):
    ...
    Originally take from github repo
    `Imbalanced Dataset Sampler 
    <https://github.com/ufoym/imbalanced-dataset-sampler>`_

    :Authors:
        Lucas Sawade (lsawade-at-princeton.edu) [only edits]

    :Last Modified:
        2021.09.17 8.50 (Lucas Sawade)
